...
public class AbstractSyntaxTree {
    ...
    private static boolean isFollowStatements;
    {
        isFollowStatements = true;
    }
    private String lexeme;
    private List<AbstractSyntaxTree> children = new ArrayList<>();
    private static final ArrayList<Integer> options = new ArrayList<>();

    public NodeType getType() {
        return type;
    }

    public static boolean isIsFollowStatements() {
        return isFollowStatements;
    }

    public static void setIsFollowStatements(boolean isFollowStatements) {
        AbstractSyntaxTree.isFollowStatements = isFollowStatements;
    }
    ...
    public void addToOptions(Integer option){
        options.add(option);
    }
